...
{
    public class ExerciseControllerTests : IClassFixture<CustomWebApplicationFactory<GymCoreTestStartup>>
    {
        private readonly CustomWebApplicationFactory<GymCoreTestStartup> _factory;
        ...
        public ExerciseControllerTests(CustomWebApplicationFactory<GymCoreTestStartup> factory)
        {
            _factory = factory;
        }
